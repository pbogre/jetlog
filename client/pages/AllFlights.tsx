...
interface FlightsFilters {
    ...
    offset?: number;
    order?: "DESC"|"ASC";
    sort?: "date"|"seat"|"seat_location"|"ticket_class"|"duration"|"distance";
    start?: string;
    end?: string;
    username?: string;
}
                ...
                <Dialog title="Filters"
                        ...
                        <>
                            ...
                            <Select name="sort"
                                ...
                                { text: "Seat Location", value: "seat_location" },
    ...
    <>
        ...
        <table className="table-auto w-full">
            <tr>
                ...
                <TableHeading text="Seat Location"/>
            ...
            <tr className="cursor-pointer even:bg-gray-100 hover:bg-gray-200 duration-75" 
                ...
                <TableCell text={flight.seatLocation || ""}/>
